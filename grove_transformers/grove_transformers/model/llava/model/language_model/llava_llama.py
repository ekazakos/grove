...
class Llava1Config(LlamaConfig):
    model_type = "llava1"


class LlavaLlamaModel(LlavaMetaModel, LlamaModel):
    config_class = Llava1Config
...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        image_forward_outs: Optional[torch.FloatTensor] = None,
        images_dtype: Optional[torch.LongTensor] = None,
        ...
        (
            ...
            image_features, image_forward_outs, images_dtype, token_embeddings, 
        )
...
AutoConfig.register("llava1", Llava1Config)
AutoModelForCausalLM.register(Llava1Config, LlavaLlamaForCausalLM)
